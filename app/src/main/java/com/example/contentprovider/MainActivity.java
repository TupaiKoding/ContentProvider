...
public class MainActivity extends AppCompatActivity {
            ...
            for (int i = 1; i < permissionNeed.size(); i++) {
                ...
                showMessage(msg, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        //requestPermissions(permissionExist.toArray(new String[permissionExist.size()]),
    ...
    private void showMessage(String msg, DialogInterface.OnClickListener onClickListener) {
